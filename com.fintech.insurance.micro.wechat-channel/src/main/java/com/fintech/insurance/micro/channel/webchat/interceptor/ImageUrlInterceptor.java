package com.fintech.insurance.micro.channel.webchat.interceptor;
...
import com.fintech.insurance.service.agg.impl.ImageUtilServiceImpl;
...
public class ImageUrlInterceptor {
    ...
    @Autowired
    ImageUtilServiceImpl imageUtilService;
