 ...
 */
@RestController
@RequestMapping(value = "/wechat/customer/contract", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
@Validated
@RequireWechatLogin
public class ContractController extends BaseFintechWechatController {
    ...
    public FintechResponse<ContractInfoVO> getRequisitionContractInfoVO(@RequestParam(value = "id") Integer id,
                                                                        @RequestParam(value = "month", defaultValue = "12") Integer month){
        LOG.info("customer getRequisitionContractInfoVO begin with id=[" + id +"]");
