 ...
 */
@RestController
@RequestMapping(path = "/wechat/customer/integration", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class WechatIntegrationBizController extends BaseFintechWechatController {
    ...
    public FintechResponse<String> createMenu(@RequestBody(required = false) WxMenu wxMenu) {
        ...
        if (wxMenu == null) {
            ...
            customerMpButtons.add(myButton);

            wxMenu.setButtons(customerMpButtons);
        }
